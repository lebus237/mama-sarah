...
export function OrderPanelLayout({ children }: { children: ReactNode }) {
   return (
      <div className="w-full h-full font-cabin text-secondary">
         ...
         <section className="xl:h-72 relative  w-full mx-auto">
               ...
               <div className="container  h-full relative">
                  <div className="absolute rounded-3xl top-2/3 right-0  bg-white z-20 xl:h-64 xl:w-[35%] shadow-[0px_0px_16px_rgba(17,17,26,0.1)] xl:px-6 xl:py-5">
                     <div className="w-full h-full flex justify-between flex-col">
                        ...
                        <div className='h-1/3 content-center border-gray-200 border-t border-b'>Possiblite de se faire livrer, ou recuperer sur place</div>
                        <div className="grid grid-cols-3">
                            {[
                                ...
                                <Link href={item.link} className={cn("block text-center space-y-1.5 py-2.5", {'text-white bg-tertiary rounded-xl': index == 0})} key={index}>
