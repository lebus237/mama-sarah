import { cs, de, enUS, es, et, fr, it, lt, lv, pl, pt, ru, tr, uk } from 'date-fns/locale'
...
export const countryOptions: { name: string; code: string }[] = [
...
export const countryCodeToName: Record<string, string> = countryOptions.reduce(
   (acc, country) => {
