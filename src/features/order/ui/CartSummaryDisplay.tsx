...
import { PinIcon, Trash2,ShoppingCart,X, icons } from 'lucide-react'
        ...
        <div className='md:p-4'>
         <header className="space-y-3 border-b border-gray-200 border-dashed">
            ...
            <div className="flex items-center justify-between mb-3">
               ...
               <span className="md:text-sm text-gray-200
                           ...
                           <div className='rounded-full w-7 h-7 border-primary hover:border flex justify-center items-center py-2'>
                              <X className=' text-gray-400
                               hover:cursor-pointer
                                hover:text-primary' onClick={() => removeItem(item.product.id, item.preferences)}
                              size={17}/>
                           </div>
                           <PriceDisplay
